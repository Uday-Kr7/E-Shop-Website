...
if (isset($_POST['register_btn'])) {
    ...
    if (empty($username) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        $check_user = "SELECT * FROM `user_login` WHERE `user_email`='$email' OR `user_name`='$username'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $insert = "INSERT INTO `user_login`(`user_name`, `user_email`, `user_password`) 
...
<body>
    ...
    <div class="container register-container">
        ...
        <form method="POST" action="user_register.php">
            ...
            <div class="text-center mt-3">
                Already have an account? <a href="user_login.php" class="text-decoration-none">Login here</a>
            </div>
        </form>
    </div>
    ...
    <div class="position-fixed top-0 end-0 p-3 mt-5" style="z-index: 9999;">
        <div id="liveToast" class="toast text-bg-<?= $toastType ?> border-0 show" role="alert" aria-live="assertive"
            aria-atomic="true">
            <div class="d-flex">
